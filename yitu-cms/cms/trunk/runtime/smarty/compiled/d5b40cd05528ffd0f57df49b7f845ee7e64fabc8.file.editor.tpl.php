<?php /* Smarty version Smarty-3.0.8, created on 2015-01-27 17:53:55
         compiled from "/Users/wangxuebing/myworks/yitu-cms/cms/trunk/views/default/index/editor.tpl" */ ?>
<?php /*%%SmartyHeaderCode:24370467154c76033100b95-06290896%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd5b40cd05528ffd0f57df49b7f845ee7e64fabc8' => 
    array (
      0 => '/Users/wangxuebing/myworks/yitu-cms/cms/trunk/views/default/index/editor.tpl',
      1 => 1422347556,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '24370467154c76033100b95-06290896',
  'function' => 
  array (
  ),
      ...
      <div class="tab">
        ...
        <div class="tablist clearfix" id="effect-main" style="display:none;">
          ...
          <div class="info">
            <p>插入图片</p>
            <div class="upload-box clearfix">
              <button id="upload_detail_face">从本地上传</button>
              <button id="detail_face_images">从图库选择</button>
            </div>
            <div class="imglist clearfix" id="detail_face"></div>
          </div>
          <div class="info">
            <button class="recovery" id="effect_update">保存</button>
          </div>
        </div>
        <div class="tablist clearfix" id="intro-main" style="display:none;">
          ...
          <div class="info top15">
            <p>标题</p>
            <input type="text" class="introbox" maxlength="30" id="intro-title">
          </div>
          <div class="info">
            <p>选择语音</p>
            <div class="upload-box clearfix">
            ...
            <div class="add-info">
              <div class="button-box">
                <div class="add-source">
                  ...
                  <div class="add-way">
                    <span id="intro-upload-image">从本地上传</span>
                    <span id="intro-box-image">从图库选择</span>
                  </div>
                </div>
                <div class="add-source">
                  <button class="add-images"><i class="iconfont">&#xe603;</i>插入全景图</button>
                  <div class="add-way">
                    <span id="intro-upload-panorama">从本地上传</span>
                    <span id="intro-box-panorama">从图库选择</span>
                  </div>
                </div>
                <button id="intro-text"><i class="iconfont">&#xe603;</i>插入文字</button>
              </div>
              <div class="addinfo-main" id="introduce-box"></div>
            </div>
          </div>
          <div class="info">
