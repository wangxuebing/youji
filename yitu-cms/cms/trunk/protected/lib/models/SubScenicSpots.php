...
class SubScenicSpots extends YituActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('language, scenic_spots_id, type_id, ctime, mtime, status, flag', 'numerical', 'integerOnly'=>true),
			...
			array('audio, face', 'length', 'max'=>40),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, language, scenic_spots_id, type_id, name, pinyin, description, longitude, latitude, around_coordinates, panorama, audio, face, ctime, mtime, status, flag', 'safe', 'on'=>'search'),
		);
	}
